...
api.gcode = (function() {
    ...
    return {
         ...
         * not change the fact that functions for cutting and pocketing the
        ...
        pocketInnerConvexPolygon : function(tips, depth, cutProperties, dogbone, safeZ) {
            ...
            // TODO: use offet-polygon for that
        ...
        //TODO: correct documentation when algorithm over
        /**
        ...
        pocketSimplePolygon : function(polygon, depth, cutProperties, safeZ) {
            ...
            // Convert the polygon in 2D for using polygon-offset library
            function convertPolygonForPolygonOffset(polygon) {
                var converted = [];
                var i = 0;
                for(i = 0; i < polygon.length; i++) {
                    converted.push([polygon[i].x, polygon[i].y]);
                }
                return converted;
            }

            var convertedPolygon = convertPolygonForPolygonOffset(polygon);
            console.log(polygon);

...
api.gcode = (function() {
    ...
    return {
        ...
        /**
         * Sets the plane in which the G2/G3 arcs are drawn on XY. Does not
         * change the fact that functions for cutting and pocketting the
        ...
        /**
         * Sets the plane in which the G2/G3 arcs are drawn on XZ. Does not
         * change the fact that functions for cutting and pocketting the
         * circles use XY plane. You should not use this function and built-in
         * functions for circle operation at the same time.
         *
        ...
        /**
         * Sets the plane in which the G2/G3 arcs are drawn on YZ. Does not
         * change the fact that functions for cutting and pocketting the
         * circles use XY plane. You should not use this function and built-in
         * functions for circle operation at the same time.
         *
         ...
         * function if you cut completely through the material.
         *
         ...
         * is not convex, the behaviour is undefined.
         *
         * @param {Vector[]} polygon - The polygon tip points.
         * @param {number} depth - The depth in inches.
         * @param {CutProperties} cutProperties - The cut properties.
         ...
         * tips is important. The bit will go to a point to the next one and
         * close the polygon by going from the last point to the first point.
         * The polygon is considered 2D on the XY plane.
         *
         * @param {Vector[]} polygon - The polygon tip points.
         * @param {number} depth - The depth in inches.
         * @param {CutProperties} cutProperties - The cut properties.
         ...
         * cutting part can be thrown because of the spindle rotation.
         *
         * @param {Vector} center - The circle center.
         * @param {number} radius - The radius in inches.
         * @param {number} depth - The depth in inches.
